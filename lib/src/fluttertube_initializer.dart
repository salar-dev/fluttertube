...
/// A utility class to ensure proper initialization of the FlutterTube dependencies.
///
/// This class provides a mechanism to initialize Flutter's widget binding and
/// the MediaKit library, which are required for proper functioning of the FlutterTube.
/// It ensures that these initializations occur only once, even if called multiple times.
class FlutterTubeInitializer {
  ...
  /// Ensures that the necessary initializations for FlutterTube are performed.
  ///
  ...
  ///
  /// Usage:
  /// Call this method in your app's main function or before using any FlutterTube functionality.
  /// Example:
  /// ```dart
  /// void main() {
  ///   FlutterTubeInitializer.ensureInitialized();
  ///   runApp(MyApp());
  /// }
  /// ```
